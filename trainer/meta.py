...
class MetaTrainer(object):
    ...
    def __init__(self, args):
        ...
        self.train_sampler = CategoriesSampler(self.trainset.labeln, self.args.num_batch, self.args.way, self.args.shot + self.args.train_query)
    ...
    def eval(self):
        ...
        self.sampler = CategoriesSampler(self.test_set.labeln, 100, self.args.way, self.args.shot + self.args.test_query)
