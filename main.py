...
if __name__ == '__main__':
    ...
    parser.add_argument('--pre_batch_size', type=int, default=8) # Batch size for pre-train phase
    ...
    parser.add_argument('--pre_init_weights', type=str, default='/home/anurag_parth/logs/pre/COCO_UNet_batchsize8_lr0.1_gamma0.2_step20_maxepoch200') # The pre-trained weights for pre-train phase
