...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_dir', type=str, default='../../MTL_Segmentation/COCO/') # Dataset folder
    ...
    parser.add_argument('--pre_batch_size', type=int, default=12) # Batch size for pre-train phase
