...
def run_exp(num_batch=100, shot=3, query=1, lr1=0.0005, lr2=0.005, base_lr=0.01, update_step=10, gamma=0.5):
    max_epoch = 200
    step_size = 20
    way=2
    gpu=0
...
run_exp(num_batch=100, shot=3, query=1, lr1=0.0005, lr2=0.005, base_lr=0.01, update_step=20, gamma=0.5)
